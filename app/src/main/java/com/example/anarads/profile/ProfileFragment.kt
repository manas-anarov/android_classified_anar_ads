...
import com.example.anarads.category.CategoryFragmentViewModel
import com.example.anarads.category.ViewModelCategoryFragmentFactory
...
//        adapter.stateRestorationPolicy = RecyclerView.Adapter.StateRestorationPolicy.PREVENT_WHEN_EMPTY
        ...
        viewModel.setToken(token_ex_ap)


        viewModel.repoResultProfile.observe(context) { result ->
            when (result) {
